...
export default function LoginForm() {
  ...
  return (
    ...
    <h1 className={`${lusitana.className} text-2xl font-bold text-center text-gray-800`}>
      ...
      <form action={formAction} className="space-y-6">
        <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-4">
          ...
          <Button className="mt-8 w-full #0284c7 text-white hover:bg-blue-600 transition duration-300" aria-disabled={isPending}>
